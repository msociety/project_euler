define(function () {
	...
	var euler = {
		info: [{
			...
			description: "<p>A Pythagorean triplet is a set of three natural numbers, a < b < c, for which,<p/><p>a<sup>2</sup> + b<sup>2</sup> = c<sup>2</sup><br/>For example, 3<sup>2</sup> + 4<sup>2</sup> = 9 + 16 = 25 = 5<sup>2</sup>.</p><p>There exists exactly one Pythagorean triplet for which a + b + c = 1000.<br/>Find the product abc.<p/>"
		}]
	}
